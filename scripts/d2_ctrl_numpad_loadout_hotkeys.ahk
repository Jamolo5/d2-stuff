...
hotkey, ^Numpad8, % LO8
hotkey, ^Numpad9, % LO9
hotkey, ^NumpadDiv, % LO10
hotkey, ^NumpadMult, % LO11
hotkey, ^NumpadSub, % LO12
...
selectloadout(loadoutnum)
{
    ...
    loop,
    {
        ...
        ; Loops to ensure that loadout menu is open
        loop, 10
        {
            PixelGetColor, color, xref, yref
            rcolor := (refcolor & 0x0F0F0F0)
		...
		; +1 loadout check score
                loadouts_loaded += 1
        }
        if (loadouts_loaded >= 9 )
        {
	    ; Loadout menu considered opened!
